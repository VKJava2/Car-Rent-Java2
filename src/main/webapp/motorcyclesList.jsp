...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
            ...
            <%
                List<Motorcycle> VehicleList = (List<Motorcycle>) request.getAttribute("model");
            ...
            <div class="row-no-margin">
                ...
                %>
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="thumbnail"><a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m"><a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m">
                                    <img src="./images/carimages/thumbs/<%= image %>" class="img-responsive"
                                         alt="<%= VehicleList.get(carIndex).getModel()%>"></a>

                                    <div class="caption">
                                        <a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m" style="text-decoration: none">
                                            <h3><%=VehicleList.get(carIndex).getMake()%></h3></a>
                                        <a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m" style="text-decoration: none">
                                            <h4><%=VehicleList.get(carIndex).getModel() %></h4></a>
                                        <ul>
                                            <li>Year: <%= VehicleList.get(carIndex).getProductionYear()%>
                                            </li>
                                            <li>Type: <%= VehicleList.get(carIndex).getMotorcycleType()%>
                                            </li>
                                        ...
                                        <p class="pull-right"><a
                                                href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m"
												...
												%>
                                            <a href="./preOrder?id=<%= VehicleList.get(carIndex).getCarId() %>&t=m"
