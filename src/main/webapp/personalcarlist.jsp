            ...
            <div class="row-no-margin">
                ...
                %>
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="thumbnail"><a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=p">
                                    <img src="./images/carimages/thumbs/<%= image %>" class="img-responsive"
                                         alt="<%= VehicleList.get(carIndex).getModel()%>"></a>

                                    <div class="caption">
                                    <a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=p" style="text-decoration: none">
                                    ...
                                    <a href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=p" style="text-decoration: none">
                                        ...
                                        <p class="pull-right"><a
                                                href="./carinfo?id=<%= VehicleList.get(carIndex).getCarId() %>&t=p"
